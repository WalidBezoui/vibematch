...
import { ArrowRight, Image as ImageIcon, User, MapPin, Tag, Type } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex items-center justify-between gap-4">
            <div className="flex-grow flex items-center gap-4">
                ...
                <div className="text-sm font-medium text-foreground/80 hidden md:flex items-center gap-2">
