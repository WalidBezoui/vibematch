...
const WhatsAppIcon = () => (
    ...
    >
      <path
        fill="currentColor"
        d="M12.04 2.01A10.02 10.02 0 0 0 2.02 12.03a10.02 10.02 0 0 0 10.02 10.02 10.02 10.02 0 0 0 10.02-10.02A10.02 10.02 0 0 0 12.04 2.01zM17.6 15.83c-.15.25-.57.42-1.07.52-.49.1-1.12.15-1.78-.04a6.5 6.5 0 0 1-3.72-2.33 7.82 7.82 0 0 1-2.58-4.48c-.15-.49-.07-1.02.22-1.48.29-.46.66-.62.88-.62.22 0 .42.02.59.04.26.04.45.06.66.42.22.36.76 1.83.82 1.96.06.13.1.29.01.46-.1.17-.15.26-.29.42-.14.15-.29.34-.41.45-.12.12-.24.26-.1.52.13.26.66 1.14 1.47 1.94.97.97 1.83 1.28 2.22 1.4.1.03.2.05.29.02.2-.07.45-.58.59-.79.14-.21.28-.18.47-.1.19.08 1.28.6 1.5.71.22.12.37.18.42.28.05.1.03.52-.12.77z"
      />
    </svg>
);
