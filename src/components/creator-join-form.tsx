                        ...
                        <FormItem className="flex items-start space-x-4 rtl:space-x-reverse cursor-pointer">
                            ...
                            <div className="grid gap-1.5 leading-none">
                              <label htmlFor="terms" className="font-medium text-foreground/80 cursor-pointer">
                                  {t('creatorJoinForm.step4.terms.label')}{' '}
                                  <Link href="/terms" target="_blank" className="font-semibold gradient-text hover:text-glow transition">
                                      {t('creatorJoinForm.step4.terms.link')}
                                  </Link>
                              </label>
                              <FormMessage />
                            </div>
