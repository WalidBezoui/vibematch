      ...
      <div className="flex h-full grow flex-col">
        <header className="px-4 md:px-10 lg:px-20 flex justify-between items-center py-6 backdrop-blur-md sticky top-0 z-50 bg-background/80 border-b">
          ...
          <nav className="hidden md:flex gap-8 items-center">
            <Link className="text-sm font-medium text-foreground/70 hover:text-primary transition-colors" href="#">Home</Link>
            <Link className="text-sm font-medium text-foreground/70 hover:text-primary transition-colors" href="#brands-faq">For Brands</Link>
            <Link className="text-sm font-medium text-foreground/70 hover:text-primary transition-colors" href="#creators-faq">For Creators</Link>
            <Link className="text-sm font-medium text-foreground/70 hover:text-primary transition-colors" href="#">Contact</Link>
          </nav>
          <Button className="gradient-bg text-black font-semibold tracking-wide hover:opacity-90 transition-all duration-300 transform hover:scale-105 hover:shadow-glow-primary rounded-full px-6">
            Join Waitlist
          </Button>
        </header>
