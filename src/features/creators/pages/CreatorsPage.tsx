...
import { MapPin, ShieldCheck, Instagram, ArrowRight, ArrowLeft, Send, HelpCircle } from 'lucide-react';
            ...
            <CardContent className="p-4 space-y-3 flex-grow">
                ...
                <div className="flex items-center justify-between text-sm font-semibold">
                    <div className="flex items-center gap-1 text-green-600">
                        ...
                        <span>{t('discoverCreators.trustScore')}: {creator.trustScore}</span>
                    </div>
                    <TooltipProvider>
                        <Tooltip>
                            ...
                            <TooltipContent>
                            <p>{t('discoverCreators.trustScoreTooltip')}</p>
                            </TooltipContent>
                        </Tooltip>
                    </TooltipProvider>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">{t('discoverCreators.followers')}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-2">
                        <TikTokIcon />
                    ...
                    {!isLoading && creators && creators.length > 0 && (
                     ...
                     {!isLoading && (!creators || creators.length === 0) && (
                        <div className="text-center py-24 border-2 border-dashed rounded-lg">
                            <h2 className="text-2xl font-semibold">{t('discoverCreators.noCreators.title')}</h2>
                            <p className="text-muted-foreground mt-2">{t('discoverCreators.noCreators.description')}</p>
                        </div>
                    )}
                </div>
            </main>
